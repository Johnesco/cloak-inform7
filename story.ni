"Cloak of Darkness" by "Roger Firth and Graham Nelson"

The story headline is "A basic IF demonstration".
The story genre is "Fantasy".
The release number is 1.
The story creation year is 2006.
The story description is "Cloak of Darkness is a standard demonstration of interactive fiction systems, originally designed by Roger Firth. This Inform 7 implementation is from the official documentation."
